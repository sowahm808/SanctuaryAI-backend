...
// PATCH /themes/:id historically shipped both names. Keep this explicit boundary
// mapper while persisting only the canonical resource `revision` field.
export class ThemeDraftUpdateDto extends ThemeInputDto { @IsOptional() expectedRevision?: string | number; @IsOptional() revision?: string | number; @IsOptional() @IsObject() draft?: Record<string, unknown>; }
